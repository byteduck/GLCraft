...
public class Keyboard {
	...
	private static HashMap<Integer,Integer> keyStates = new HashMap<Integer,Integer>();
	
	public static boolean isKeyDown(int key){
		return GLFW.glfwGetKey(GLCraft.getGLCraft().window, key) == GLFW.GLFW_PRESS;
	}
	
	public static void initKeyboard(){
		GLFW.glfwSetKeyCallback(GLCraft.getGLCraft().window, keyCallback = new GLFWKeyCallback(){

			@Override
			public void invoke(long window, int key, int scancode, int action, int mods) {
				keyStates.put(scancode, action);
			}
	...
	public static boolean keyJustPressed(int key){
		if(keyStates.containsKey(key)){
			if(keyStates.get(key) == GLFW.GLFW_PRESS)
				return true;
		}
		return false;
	}
	...
	public static boolean keyJustReleased(int key){
		if(keyStates.containsKey(key)){
			if(keyStates.get(key) == GLFW.GLFW_RELEASE)
				return true;
		}
		return false;
	}
